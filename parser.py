...
print('mean')
print(np.mean(np.array(trains)))
print(np.mean(np.array(retains)))
print(np.mean(np.array(forgets)))
print(np.mean(np.array(vals)))
print(np.mean(np.array(tests)))
print('std')
...
print('mean')
print(np.mean(np.array(corr)))
print(np.mean(np.array(conf)))
print(np.mean(np.array(ent)))
print(np.mean(np.array(ment)))
print('std')
